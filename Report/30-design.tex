...
Каждой группе ресурсов соответствует набор endpoint'ов, объединенных общим префиксом \texttt{/api}. Для отладки и тестирования API на этапе разработки использовались Swagger-интерфейс (\texttt{/api/docs/}) и ручная проверка запросов в Insomnia/Postman \cite{openapi_spec_3_1,insomnia_docs_2026}.
